...
import com.example.r.refreshlayout.cell.EmptyCell;
import com.example.r.refreshlayout.cell.ErrorCell;
import com.example.r.refreshlayout.cell.LoadMoreCell;
import com.example.r.refreshlayout.cell.LoadingCell;
...
public class RVSimpleAdapter extends RVBaseAdapter{
    ...
    @Override
    protected void onViewHolderBond(RVBaseViewHolder holder, int position) {
